...
const BookinForm: React.FC = () => {
  return (
    <div className="w-[480px] bg-white shadow-md border border-[#E6E6E6] rounded-lg p-5">
      {/* Price & Cancellation */}
      <div className="mb-4">
        <h4 className="text-[#6F6F6F] text-[14px] font-bold">
          NGN 85,000 <span className="font-normal">/night</span>
        </h4>
      ...
      <div className="flex items-center rounded-md bg-white border border-[#E6E6E6] px-4 py-3 mt-3">
        <div className="flex flex-col">
          ...
          <p className="text-[#313131] text-[14px] font-medium ml-auto">
            2 travelers
          </p>
        </div>
      </div>
      ...
      <div className="mt-4 flex flex-col items-center">
        ...
        <p className="text-[#730071] text-[14px] font-medium cursor-pointer hover:underline mt-1">
          Contact host
        </p>
      </div>
    </div>
