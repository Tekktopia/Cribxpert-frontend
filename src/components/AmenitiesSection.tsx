...
const AmenitiesSection = () => (
    <div className="py-8">
      ...
      <div className="mt-5">
        <div className="flex flex-row items-center gap-14">
          <div className="w-[158px] h-[100px] space-y-3">
            <div className="flex flex-row gap-5">
              <img src={parkingIcon} alt="Parking" className="w-[16px] h-[16px]" />
              <p className="text-[#313131] font-[400] text-[14px]">Parking Available</p>
            </div>
            <div className="flex flex-row gap-5">
              <img src={airConditioning} alt="Air Conditioning" className="w-[16px] h-[16px]" />
              <p className="text-[#313131] font-[400] text-[14px]">Air Conditioning</p>
            </div>
            <div className="flex flex-row gap-5">
              <img src={kitchenIcon} alt="Kitchen" className="w-[16px] h-[16px]" />
          ...
          <div className="w-[158px] h-[100px] space-y-3">
            ...
            <div className="flex flex-row gap-5">
              ...
              <p className="text-[#313131] font-[400] text-[14px]">24/7 WIFI connection</p>
            </div>
            <div className="flex flex-row gap-5">
        ...
        <p className="text-[#730071] font-[400] ">
          See all popular amenities </p>
