    ...
    <div className="grid grid-cols-2 gap-4">
      {[GalleryOne, GalleryTwo, GalleryThree, GalleryFive].map((src, index) => (
        <div key={index} className="relative">
          <img src={src} className="w-full h-auto max-w-[300px] max-h-[244px] object-cover" />
          <div className="absolute inset-0 bg-black bg-opacity-20"></div>
        </div>
      ))}
    </div>
...
<div className="mt-3">
    <p className="font-[400] text-[14px] text-[#313131]">Federal Capital Territory Gombe</p>
    <p>View in map <span>
        <img src={arrowright} alt="arrow-right" className="w-[16px] h-[16px]"/></span></p>
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="font-[400] text-[14px] text-[#999999]">2 min walk</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        <img src={location} alt="location" className="w-[20px] h-[20px]" />
        <div>
          <p className="font-[400] text-[14px] text-[#6F6F6F]">Ventura Mall</p>
          <p className="font-[400] text-[14px] text-[#999999]">10 min walk</p>
        </div>
      </div>

      {/* Location Item 3 */}
      <div className="flex items-center gap-3">
        <img src={airportStation} alt="airport" className="w-[20px] h-[20px]" />
        <div>
          <p className="font-[400] text-[14px] text-[#6F6F6F]">National Airport Station</p>
          <p className="font-[400] text-[14px] text-[#999999]">24 min walk</p>
        </div>
      </div>
      ...
      <p className="text-[#E0E0E0] flex items-center gap-2 cursor-pointer">
        See more about area 
        <img src={arrowright} alt="arrow-right" className="w-[16px] h-[16px]" />
      </p>
    </div>
  </div>
</section>
  ...
  <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-start gap-8">
    <div>
    <h2 className="text-[20px] text-[#040404] font-[400]">Verifies Ratings (1394)</h2>
    </div>
...
<p className="text-[#313131] text-[14px] font-[500] mt-3">1394 verifies ratings</p>
      </div>
