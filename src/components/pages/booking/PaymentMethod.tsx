      ...
      <section className="container mx-auto p-6">
        <div className="flex flex-col md:flex-row md:gap-6 relative">
          ...
          <div className="md:w-1/3 w-full flex flex-col">
            ...
            <h1 className="text-lg font-semibold text-gray-800 -mb-4">Payment Method</h1>
            <div className="border border-[#F1E6F1] rounded-lg p-4 mt-6 flex-grow ">
              <div className="flex flex-col gap-3">
                {paymentMethods.map((method, index) => (
                  ...
                  >
                    <img src={method.icon} alt={method.name} className="w-[24px] h-[24px] mr-3" />
                    <p className={`text-gray-700 font-medium ${selectedMethod === method.name ? "text-[#730071]" : ""}`}>
                      {method.name}
                    </p>
                  </div>
                ))}
          ...
          <div className="md:w-2/3 w-full flex flex-col">
            ...
            <h1 className="text-lg font-semibold text-gray-800 -mb-4">Payment Details</h1>
              ...
              <div className="p-5 bg-[#f8e6f8] rounded-lg shadow-md">
                ...
                <div className="space-y-4 text-gray-800 text-sm">
                  ...
                  <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                    <div>
                      <p className="text-[#6F6F6F] font-medium">Account Number</p>
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <div>
                      ...
                      <p className="text-[#730071] font-bold text-lg">NGN 50,000</p>
                    </div>
                    <img
                      src={copyIcon}
                      alt="CopyIcon"
                ...
                <p className="text-center text-gray-600 mt-3">
                  ...
                  <span className="text-lg font-semibold text-[#730071]">09:30</span>
                </p>
              </div>
            </div>
          </div>
