...
const StepFour: React.FC = () => {
  ...
  return (
    <div className="relative w-1/2 flex flex-col items-center justify-center p-8">
      <p className="text-gray-500 text-sm mb-2 fixed top-4 right-4">STEP 04/04</p>
      ...
      <div className="w-full max-w-[512px] text-center">
        ...
        <div className="w-full space-y-4 px-2 overflow-y-scroll max-h-[60vh] custom-scrollbar">
          {/* First Name */}
          <div>
            <label className="block text-left text-gray-700 font-medium mb-1">First Name</label>
            <input
              type="text"
              name="firstName"
          ...
          {/* Last Name */}
          <div>
            <label className="block text-left text-gray-700 font-medium mb-1">Last Name</label>
            <input
              type="text"
              name="lastName"
          ...
          <div className="relative">
            <label className="block text-left text-gray-700 font-medium mb-1">Date of Birth</label>
            <input
              type="date"
              name="dateOfBirth"
          ...
          <ul className="text-sm grid grid-cols-2 mt-2">
            {Object.entries(passwordCriteria).map(([key, met]) => (
              <li key={key} className={`flex items-center gap-2 ${met ? "text-green-500" : "text-gray-500"}`}>
