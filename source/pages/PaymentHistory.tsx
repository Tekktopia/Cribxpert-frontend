        ...
        <div className="px-4 sm:px-6 lg:px-8 py-8 max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-t-lg mb-6 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4">
              ...
              {/* Filters Button */}
              <button className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2B7B8B]">
                <svg
